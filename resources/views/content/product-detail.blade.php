                        ...
                        <div class="sidebar-l sidebar-right js-sso-checkout-experiment">
                                                    ...
                                                    <div data-action="follow-shop-listing-header" class=" wt-mb-xs-1">
                                                        <div class="wt-display-flex-xs wt-align-items-center">
                                                            <p class="wt-text-body-01">
                                                                <a class="wt-text-link-no-underline"
                                                                    ...
                                                                    aria-label="View more products from store owner {{ $template->studioName }}">
                                                        ...
                                                        <div>
                                                            <div
                                                                ...
                                                                <div
                                                                    class="wt-flex-basis-lg-full wt-flex-basis-xl-auto wt-mb-xs-1">
                                                                    <div class="star-seller-badge ">
                                                                        <div class="wt-popover star-seller-badge-listing-page wt-display-flex-xs"
                                                                            ...
                                                                            <button data-wt-popover-trigger=""
                                                                                ...
                                                                                <p
                                                                                    class="wt-text-caption-title wt-ml-xs-1">
                                                                                    Star Seller
                                                                                </p>
                                                                            </button>
                                                                ...
                                                                <span
                                                                    class="wt-ml-xs-1 wt-mr-xs-1 wt-mb-xs-1 wt-display-inline-block"
                                                                    style="color: #e1e3df;">|</span>
                                                                ...
                                                                <span class="wt-mb-xs-1 wt-display-inline-block">
                                                                    <a class="wt-text-link-no-underline ssh-review-stars-text-decoration-none wt-display-inline-flex-xs wt-align-items-center wt-nudge-b-1"
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            <input type="hidden" name="initial-rating"
                            ...
                            <div class="box -radius-all">
                                <div class="rating-detailed--has-no-ratings">
                                    <div
                                        class="MuiGrid-root MuiGrid-container MuiGrid-direction-xs-column mui-p2asnn">
                                        ...
                                        <div class="MuiBox-root mui-1uc6yu5-iconBox">
                                            <div class="MuiBox-root mui-k008qs"><svg
                                                    class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium mui-10dohqv"
                                                    focusable="false" aria-hidden="true" viewBox="0 0 32 32"
                                                    data-testid="Illustrations.svgIcon">
                                                    <path
                                            ...
                                            <div class="MuiBox-root mui-k008qs"><svg
                                                    class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium mui-10dohqv"
                                                    focusable="false" aria-hidden="true" viewBox="0 0 32 32"
                                                    data-testid="ArrowDown.svgIcon">
                                                    <path
                                                        d="M23.067 16.533l-5.733 5.733V5.999h-2.667v16.267l-5.733-5.733L7.067 18.4 16 27.333l8.933-8.933z">
                                                    </path>
                                                </svg>
                                                <h6 class="MuiTypography-root MuiTypography-body1 MuiTypography-alignCenter mui-usehnw-iconText">
                                            ...
                                            <div class="MuiBox-root mui-k008qs"><svg
                                                    class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium mui-10dohqv"
                                                    focusable="false" aria-hidden="true" viewBox="0 0 32 32"
                                                    data-testid="Collections.svgIcon">
                                                    <path
                                                        d="M16 9.333v-4H2.667v21.333H24c2.946 0 5.333-2.388 5.333-5.333v-12zm10.667 12C26.667 22.806 25.473 24 24 24H5.333V8h8v2.667c0 .736.597 1.333 1.333 1.333h12z">
                                                    </path>
                                                </svg>
                                                <h6
                                                    class="MuiTypography-root MuiTypography-body1 MuiTypography-alignCenter mui-usehnw-iconText">
                                                    Share and publish anywhere</h6>
                                            </div>
                                            <div class="MuiBox-root mui-k008qs"><svg
                                                    class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium mui-10dohqv"
                                                    focusable="false" aria-hidden="true" viewBox="0 0 32 32"
                                                    data-testid="Blog.svgIcon">
                                                    <path
                                            ...
                                            <div class="MuiBox-root mui-k008qs"><svg
                                                    class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium mui-10dohqv"
                                                    focusable="false" aria-hidden="true" viewBox="0 0 32 32"
                                                    data-testid="Rotate.svgIcon">
                                                    <path
                                                        d="M28 17.333C28 10 22 4 14.667 4 12.4 4 10.4 4.533 8.534 5.6L6.667 2.667l-2.667 8h8l-2-2.933c1.467-.667 3.067-1.067 4.667-1.067 5.867 0 10.667 4.8 10.667 10.667h2.667z">
                                                    </path>
                                                    <path
                                                        d="M4 28h13.333c2.933 0 5.333-2.4 5.333-5.333v-9.333H3.999v14.667zm2.667-2.667V16H20v6.667c0 1.467-1.2 2.667-2.667 2.667H6.666z">
                                                    </path>
                                                </svg>
                                                <h6
                                                    class="MuiTypography-root MuiTypography-body1 MuiTypography-alignCenter mui-usehnw-iconText">
