...
<section id="_main_content">
                        ...
                        <div class="wpb_single_image wpb_content_element vc_align_left   top-112">
                            <figure class="wpb_wrapper vc_figure">
                                <div class="vc_single_image-wrapper   vc_box_border_grey">
                                    <img loading="lazy" srcset="{{ asset('assets/img/category-300x297.png') }} 300w,{{ asset('assets/img/category-1024x1013.png') }} 1024w,{{ asset('assets/img/category-1500x1484.png') }} 1536w" sizes="(max-width: 414px) 300px, (max-width: 720px) 600px, 1024px" class="vc_single_image-img" src="img/category-300x297.png"
    ...
    <script>
        ...
        function getPenPath() {
            ...
            return `{{ route('showCategoryLevel'.$url_params['cat_lvl'], $url_params['slugs']) }}?page=${pageNumber}`;
        }
