...
<head>
    ...
    width: 0;
            ...
            *:after {
            ...
            .e-btn--3d.-color-primary:active {
                top: 1px;
                -webkit-box-shadow: 0 1px 0 #31af36;
                box-shadow: 0 1px 0 #31af36;
            }
        }

        /*! CSS Used from: https://public-assets.envato-static.com/assets/market/pages/preview/index-701cd44de39ff0d37f7a6131f450d601714d003063f036644d3a46fcf0c98246.css ; media=all */
        @media all {
            .full-screen-preview {
                height: 100%;
                padding: 0px;
    ...
    position: relative;
            ...
            .preview__envato-logo a {
                ...
                height: 23px;
                width: 117px;
                background: url(http://localhost:8001/assets/img/logo.png);
